...
export default class SummaryTool extends BaseTool {
    ...
    As a release engineer, look at the diff and provide an informative concise summary of the changes being released. Also discuss the possible impact of the code changes on stability and performance.
    If there is no impact say so concisely.
    OUTPUT:
    `;
